...
const ProductDetails = () => {
  ...
  return (
    <div className="container mx-auto mt-8">
      <Link to="/cart">
        <div className="relative flex items-center justify-end space-x-2 mr-5 lg:mr-0">
          <svg
            ...
            className="w-8 h-8 mr-5 text-black"
          >
          ...
          {cartCount > 0 && (
            <div className="absolute bottom-4 right-0  bg-red-500 text-white text-md rounded-full px-2">
              {cartCount}
            </div>
          )}
        </div>
      ...
      <div className="max-w-4xl mx-auto bg-white p-8">
        ...
        <p className="text-gray-600 mb-2 text-xl lg:text-5xl">
          {" "}
          {product.brand}
        </p>
            ...
            <div key={index} className="relative">
              ...
              <FaHeart
                className={`absolute top-2 right-2 ${
                  isProductFavourite ? "text-red-500" : "text-black"
                } cursor-pointer`}
        ...
        <div className="flex gap-5 mt-10 lg:mt-5">
          <p className="text-blue-900 mb-2 lg:text-xl text-lg">
            Price: ${product.price}
          </p>
          <p className="text-white bg-blue-900 rounded-lg lg:p-2 text-sm p-2  mb-2">
            {" "}
        ...
        <div className=" lg:gap-5 mt-2">
          <button
            className="bg-white text-blue-900 border border-blue-950 py-2 px-4 rounded-lg hover:bg-blue-900 hover:text-white mr-2"
