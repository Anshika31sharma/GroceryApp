...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100">
      <div style={{ backgroundColor: "#332a9f" }} className=" w-full top-0">
        <header className="flex items-center justify-between w-full lg:p-10 mt-5 lg:mt-0">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/cart">
              <div className="relative flex items-center space-x-2 mr-5 lg:mr-0">
                <svg
                ...
                {cartCount > 0 && (
                  <div className="absolute bottom-4 left-3 bg-red-500 text-white text-md rounded-full px-2">
                    {cartCount}
                  </div>
                )}
              </div>
        ...
        <div className="flex  items-start lg:justify-start md:justify-start w-full p-4 ">
      ...
      <div className="lg:flex grid grid-cols-1 lg:grid-cols-3  md:grid-cols-3 md:gap-5 w-full p-4 ">
        <div className="lg:w-1/3  w-full lg:p-10">
          <img
